...
class FilterSetTest extends \PHPUnit_Framework_TestCase {
	...
	public function testFilterForCount() {
		...
		$this->FilterSet = $this->getMockBuilder('Summe\Slice\Filter\FilterSet')
		...
		$aliasResolver = $this->getMockBuilder('Summe\Slice\AliasResolver\AliasResolver')
			->disableOriginalConstructor()
			->getMock();
	...
	public function testFilterForSelectRows() {
		...
		$pagingFilter = $this->getMockBuilder('Summe\Slice\Filter\PagingFilter')
	...
	public function testApplyFiltersAndJoins() 
	{
		...
		$orderFilter = $this->getMockBuilder('Summe\Slice\Filter\OrderByFilter')

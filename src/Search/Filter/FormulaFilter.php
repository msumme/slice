...
class FormulaFilter implements CriteriaFilterInterface, PropertyPathFilterInterface
{
	...
	/**
	 * 
	 * @see \Slice\Search\Filter\CriteriaFilterInterface::getDQL()
	 */
	...
	/* (non-PHPdoc)
	 * @see \Slice\Search\Filter\CriteriaFilterInterface::getParameters()
	 */
	...
	/* (non-PHPdoc)
	 * @see \Slice\Search\Filter\FilterInterface::modifyQueryBuilder()
	 */
